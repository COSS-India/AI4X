...
const dhruvaAPI: { [key: string]: string } = {
  ...
  vadInference: `${dhruvaRootURL}/services/inference/vad`,
  s2sInference: `${dhruvaRootURL}/services/inference/s2s`,
  ...
  pipelineTransliteration: `${dhruvaRootURL}/services/inference/pipeline/transliteration`,
  pipelineOcr: `${dhruvaRootURL}/services/inference/pipeline/ocr`,
  pipelineTextLangDetection: `${dhruvaRootURL}/services/inference/pipeline/txt-lang-detection`,
  pipelineAudioLangDetection: `${dhruvaRootURL}/services/inference/pipeline/audio-lang-detection`,
  pipelineSpeakerDiarization: `${dhruvaRootURL}/services/inference/pipeline/speaker-diarization`,
  pipelineLanguageDiarization: `${dhruvaRootURL}/services/inference/pipeline/language-diarization`,
  pipelineSpeakerVerification: `${dhruvaRootURL}/services/inference/pipeline/speaker-verification`,
